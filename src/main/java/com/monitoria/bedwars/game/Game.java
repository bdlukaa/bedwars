...
public class Game {
    ...
    void resetar() {
        ...
        teams.add(new Team(Color.YELLOW, -51, 52, 49, new ItemSpawner(new Location(world, -51, 52, 49), null, 0), Material.PINK_BED));
        // teams.add(new Team(Color.BLUE, 99, 52, 50, new ItemSpawner(new Location(world, 99, 50, 54), null, 0), Material.BLUE_BED));


        itemSpawnPoints.clear();
        itemSpawnPoints.add(new ItemSpawner(new Location(world, 69, 51 + 2, 0), Material.DIAMOND, 100));
        itemSpawnPoints.add(new ItemSpawner(new Location(world, 127, 51 + 2, 1), Material.EMERALD, 300));
        itemSpawnPoints.add(new ItemSpawner(new Location(world, 2, 45 + 2, -9), Material.EMERALD, 300));
        itemSpawnPoints.add(new ItemSpawner(new Location(world, -12, 57 + 2, 10), Material.EMERALD, 300));
        itemSpawnPoints.add(new ItemSpawner(new Location(world, -136, 51 + 2, 0), Material.EMERALD, 300));
        itemSpawnPoints.add(new ItemSpawner(new Location(world, -78, 51 + 2, 1), Material.DIAMOND, 100));
